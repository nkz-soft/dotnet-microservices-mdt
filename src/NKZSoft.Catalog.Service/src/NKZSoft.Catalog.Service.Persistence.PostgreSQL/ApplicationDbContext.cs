using NKZSoft.Catalog.Service.Persistence.PostgreSQL.Common;
using NKZSoft.Catalog.Service.Persistence.PostgreSQL.Extensions;
...
public class ApplicationDbContext : DbContext, IApplicationDbContext
{
    ...
    {
        foreach (var entry in ChangeTracker.Entries<IBaseAuditableEntity<Guid>>())
        {
            switch (entry.State)
            {
